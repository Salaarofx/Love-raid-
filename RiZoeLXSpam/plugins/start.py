...
Riz_Button = [
        [
        Button.url("ᴄʜᴀɴɴᴇʟ", "https://t.me/Notyouaagain"),
        Button.url("sᴜᴘᴘᴏʀᴛ", "https://t.me/Notyouaagain")
        ],
        [
        Button.url("• ʀᴇᴘᴏ •", "https://github.com/Salaarofx/Love-raid-")
        ]
        ]
